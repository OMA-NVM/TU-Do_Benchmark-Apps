deps_config := \
	/usr/src/apps/lesolve/Config.uk \
	...
	/usr/src/apps/lesolve/build/kconfig/libs.uk \
	...
	/usr/src/apps/lesolve/build/kconfig/plat.uk \
...
/usr/src/apps/lesolve/build/kconfig/auto.conf: \
	$(deps_config)

ifneq "$(UK_FULLVERSION)" "0.8.0~507b1e9"
/usr/src/apps/lesolve/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(UK_APP)" "/usr/src/apps/lesolve"
/usr/src/apps/lesolve/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(KCONFIG_PLAT_IN)" "/usr/src/apps/lesolve/build/kconfig/plat.uk"
/usr/src/apps/lesolve/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(KCONFIG_LIB_IN)" "/usr/src/apps/lesolve/build/kconfig/libs.uk"
/usr/src/apps/lesolve/build/kconfig/auto.conf: FORCE
endif
ifneq "$(KCONFIG_APP_DIR)" "/usr/src/apps/lesolve"
/usr/src/apps/lesolve/build/kconfig/auto.conf: FORCE
endif
