deps_config := \
	...
	/usr/src/apps/qsort/build/kconfig/libs.uk \
	...
	/usr/src/apps/qsort/build/kconfig/plat.uk \
...
/usr/src/apps/qsort/build/kconfig/auto.conf: \
	$(deps_config)

ifneq "$(UK_FULLVERSION)" "0.8.0~507b1e9"
/usr/src/apps/qsort/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(UK_APP)" "/usr/src/apps/qsort"
/usr/src/apps/qsort/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(KCONFIG_PLAT_IN)" "/usr/src/apps/qsort/build/kconfig/plat.uk"
/usr/src/apps/qsort/build/kconfig/auto.conf: FORCE
endif
...
ifneq "$(KCONFIG_LIB_IN)" "/usr/src/apps/qsort/build/kconfig/libs.uk"
/usr/src/apps/qsort/build/kconfig/auto.conf: FORCE
endif
ifneq "$(KCONFIG_APP_DIR)" "/usr/src/apps/qsort"
/usr/src/apps/qsort/build/kconfig/auto.conf: FORCE
endif
